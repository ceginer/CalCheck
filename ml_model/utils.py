...
print("1",label_map) # 'mango': 1
print("2",label_color_map) # 'mango': '#e6194b'
print("3",rev_label_map) # 1:'mango'
...
def create_data_lists(custom_path, output_folder):
    ...
    # Save to file
    with open(os.path.join(output_folder, 'train_images_jeongin.json'), 'w') as j:
        json.dump(train_images, j)
    with open(os.path.join(output_folder, 'train_objects_jeongin.json'), 'w') as j:
